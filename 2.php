                                        ...
                                        <div class="row">
                                            ...
                                            <script type="text/javascript">
												function ChangetoKhmer() {
														...
														{
															khmer.value = parseFloat(dolar.value) * 4000;
														}
													}
												...
												/*$("#myForm input").each(function(this){
													$(this).keyup(function(){
														var dolar = $("#dolar").val();
														var khmer = $("#khmer").val();
														
														dolar = $.isNumeric(dolar)?dolar:0;
														khmer = $.isNumeric(khmer)?khmer:0;
														
														$("#dolar").val(parseFloat(khmer)/parseFloat(4000));
														
														$("#khmer").val(parseFloat(dolar)*parseFloat(4000));

                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                                     ...
                                                     <div class="col-md-12 pull-right">
                                                      ...
                                                      <div class="form-group">
                                                          ...
                                                          <?php
																	...
																	$select=$db->query("SELECT BranchID, BranchName FROM `tblbranch` where BranchID='".$U_Brandid."' order by BranchID;");
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="col-md-1 text-center">Price Salling</th>  
                                        ...
                                        <?php
											...
											if($rowselect>0){
												...
												echo'<tr class="even">
														...
														<a href="frmbuyPrice.php?PrdBranchID='.$PrdBranchID.'&PrdBranchName='.$ProductName.'&PrdBranchCode='.$ProductCode.'&PrdBranchPrice='.$SalePrice.'&buyprice='.$BuyPrice.'&SPrdBrandID='.$getBranchID.'">
